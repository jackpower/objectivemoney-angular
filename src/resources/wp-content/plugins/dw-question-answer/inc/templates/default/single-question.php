...
?>
	<?php if ( have_posts() ) : ?>
		<?php while ( have_posts() ) : the_post(); ?>
            ...
            <p><small>Note: The content of this website is intended for general information only and is not intended to serve as financial or other advice. Objective Money and its contributors do not guarantee, express or implied, the availability or the accuracy of information, nor is it responsible for any decisions taken, based on this information.</small></p>
